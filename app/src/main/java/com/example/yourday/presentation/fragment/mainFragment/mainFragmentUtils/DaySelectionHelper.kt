package com.example.yourday.presentation.fragment.mainFragment.mainFragmentUtils

import android.widget.TextView
import com.example.yourday.R
import com.example.yourday.databinding.DaySelectionLayoutBinding
    ...
    private fun initFun(){
        with(selector){
            ...
            previousWeek.setOnClickListener{
                initCalendar(false, BackOrNextWeek.BACK)
                previousWeekClick?.invoke()
            }
            nextWeek.setOnClickListener{
                initCalendar(false, BackOrNextWeek.NEXT)
